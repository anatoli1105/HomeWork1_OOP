public class Kogtewrun extends Hogwars{
    ...
    public Kogtewrun(String student, int powerMagic, int teleport,int intellect,
    ...
    public static void compareStudentsKogtewran(Kogtewrun student1,Kogtewrun student2) {
        if (student1.getCreation() + student1.getIntellect() + student1.getWisdom()+student1.wit
            ...
            System.out.println(student2.getStudent() +" ,факультета "+student2.facultet+
                    ", обладает бОльшей мощностью магии, чем " +
                    student1.getStudent());
        }
    }
