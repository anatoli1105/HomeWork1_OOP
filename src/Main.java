...
public class Main {
    public static void main(String[] args) {
        ...
        Hogwars student6=new Slisaren("Грегори Гойл",4,
                34,66,77,33,12,21);
        Hogwars student7=new Kogtewrun("Чжоу Чанг",44,
                44,67,76,6,7);
        Hogwars student8=new Kogtewrun("Падма Патил",90,
                9,5,45,41,4);
        Hogwars student9=new Kogtewrun("Маркус Белби",2,
                22,56,71,72,73);
        ...
        System.out.println();
        Kogtewrun.compareStudentsKogtewran((Kogtewrun) student7,(Kogtewrun) student8);
        System.out.println();
